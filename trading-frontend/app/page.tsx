                            ...
                            <div className="space-y-2">
                                ...
                                <Select>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="atr">Stochastic Oscillator</SelectItem>
                                        ...
                                        <SelectItem value="donchain channels">Donchain Channels</SelectItem>
                                        <SelectItem value="parabollic sar">Parabollic SAR</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <div className="space-y-2">
